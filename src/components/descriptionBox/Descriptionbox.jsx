...
const DescriptionBox = () => {
  ...
  const descriptionContent = (
    <div className="descBox-desc flex flex-col gap-6 border-2 border-[#d0d0d0] p-10">
      <p>
    ...
    <>
      <div className="my-[120px] mx-[120px]">
        <div style={{ display: "flex", cursor: "pointer", marginBottom: "0" }}>
          <div
            className="descBox-nav-box flex items-center justify-center text-[16px] font-semibold w-[170px] h-[70px] border-2 border-[#d0d0d0]"
