  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between bg-white w-[730px] h-[70px] rounded-[80px] border-[#e3e3e3] max-[400px]:mt-[20px] max-[400px]:w-[300px] max-[400px]:h-[40px] max-[500px]:w-[400px] max-[500px]:h-[50px]">
          <input
            type="email"
